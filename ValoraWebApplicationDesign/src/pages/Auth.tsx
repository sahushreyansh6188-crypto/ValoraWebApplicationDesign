...
function LoginForm({ onLogin, switchTo }: { onLogin: () => void; switchTo: (m: AuthMode) => void }) {
  ...
  return (
    <form onSubmit={submit} noValidate className="space-y-5" aria-label="Sign in form">
      ...
      <button type="button" className="w-full border border-mist bg-white py-3 rounded-full text-sm text-flint font-medium flex items-center justify-center gap-2 hover:bg-cream transition-colors">
